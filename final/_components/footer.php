  <!-- Main Content Ends -->
  <footer>
  <img class="footerLogo" src=" <?php echo site_url(); ?>/dist/images/Tasty-Times-Logo.svg" alt="Tasty Times Logo" >
    <p>
      &copy;<?php echo date('Y'); ?> Tasty Times co. All Rights Reserved
    </p>
  </footer>
